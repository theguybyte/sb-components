...
export declare const CustomerBackgroundColor: ComponentStory<({ allCaps, color, label, size, fontColor, backgroundColor }: import("./../../components/MyLabel").MyLabelProps) => JSX.Element>;
